package uk.co.alt236.btlescan_mini.adapters;
...
import uk.co.alt236.btlescan_mini.util.Constants;
...
public class LeDeviceListAdapter extends SimpleCursorAdapter {
    ...
    public View getView(final int i, View view, final ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            //viewHolder.buttonConnectDev = (Button)  view.findViewById(R.id.buttonConnectDev);
            //viewHolder.buttonInfoDev = (Button)  view.findViewById(R.id.buttonInfoDev);
        ...
        if (BeaconUtils.getBeaconType(device) == BeaconType.IBEACON) {
            ...
            viewHolder.deviceIcon.setImageResource(R.drawable.rashodometr);
    ...
    static class ViewHolder {
        ...
        //Button buttonConnectDev;
        //Button buttonInfoDev;
    }
