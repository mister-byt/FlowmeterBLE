 ...
 */
public class DeviceReadMyUUIDs extends AppCompatActivity {
...
*/
    ...
    public void onSysClick(View view)
    {
        ...
        getDialog(DeviceReadMyUUIDs.this).show();
    }
    ...
    private final BroadcastReceiver mGattUpdateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(final Context context, final Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                mMyFlow = mMyService.getCharacteristic(UUID.fromString(MY_GATT_CHARACTERISTIC4));
               ...
               //ErrorGetCharacteristic();
                ...
                if (uuid.equals(MY_GATT_CHARACTERISTIC1)) {
                    ...
                    hex_error_code = String.format("0x%02X%02X%02X%02X", dataArr[0] & 0xFF, dataArr[1] & 0xFF, dataArr[2] & 0xFF, dataArr[3] & 0xFF);
                ...
                if (uuid.equals(MY_GATT_CHARACTERISTIC4)) {
                    if (mMyCharacteristic.getUuid().equals(mMyFlow.getUuid())) {
                        ...
                        String btdata = String.format("%d.%03d l/h", /*Long.valueOf((((dataArr[0] & 0xFF) * 256 * 256 * 256) + ((dataArr[1] & 0xFF) * 256 * 256) + ((dataArr[2] & 0xFF) * 256) + (dataArr[3] & 0xFF)))*/longpart_1, /*Long.valueOf((((dataArr[4] & 0xFF) * 256 * 256 *256) + ((dataArr[5] & 0xFF) * 256 * 256)+((dataArr[6] & 0xFF) * 256 ) + (dataArr[7] & 0xFF)))&0xFFFFFFFF */Intpart);
                        mTextView1 = (TextView) findViewById(R.id.textView1);
                        mTextView1.setText(hexdata);
                        mTextView2 = (TextView) findViewById(R.id.textView2);
                        mTextView2.setText(btdata);
                        ...
                        //String hexdata = String.format("Input HEX value: 0x%02X%02X%02X%02X%02X%02X%02X%02X", dataArr[0] & 0xFF, dataArr[1] & 0xFF, dataArr[2] & 0xFF, dataArr[3] & 0xFF, dataArr[4] & 0xFF, dataArr[5] & 0xFF, dataArr[6] & 0xFF, dataArr[7] & 0xFF);
                        //String btdata = String.format("%d.%03d l/h", Long.valueOf((((dataArr[0] & 0xFF) * 256 * 256 * 256) + ((dataArr[1] & 0xFF) * 256 * 256) + ((dataArr[2] & 0xFF) * 256) + (dataArr[3] & 0xFF))), /*Long.valueOf((((dataArr[4] & 0xFF) * 256 * 256 *256) + ((dataArr[5] & 0xFF) * 256 * 256)+((dataArr[6] & 0xFF) * 256 ) + (dataArr[7] & 0xFF)))&0xFFFFFFFF */Intpart);

                        Long now_flow = 0L;
                        now_flow = longpart_1;/*((dataArr[0] & 0xFF) * 256 * 256 * 256) + ((dataArr[1] & 0xFF) * 256 * 256) + ((dataArr[2] & 0xFF) * 256) + (dataArr[3] & 0xFF);*/
                        if (now_flow>0){
                            flow_in_percent = (ProgressBar) findViewById(R.id.progressBar2);
                            flow_in_percent.setProgress(now_flow.intValue());
                        }
                ...
                if ( uuid.equals(MY_GATT_CHARACTERISTIC5)) {
                    ...
                    String hexdata = String.format("Input HEX value: 0x%02X%02X%02X%02X%02X%02X%02X%02X", dataArr[0] & 0xFF, dataArr[1] & 0xFF, dataArr[2] & 0xFF, dataArr[3] & 0xFF, dataArr[4] & 0xFF, dataArr[5] & 0xFF, dataArr[6] & 0xFF, dataArr[7] & 0xFF);
                    String btdata = String.format("%d.%03d m3", longpart_1/*Long.valueOf((((dataArr[0] & 0xFF) * 256 * 256 * 256) + ((dataArr[1] & 0xFF) * 256 * 256)+((dataArr[2] & 0xFF) * 256) + (dataArr[3] & 0xFF)))*/, /*Long.valueOf((((dataArr[4] & 0xFF) * 256 * 256 *256) + ((dataArr[5] & 0xFF) * 256 * 256)+((dataArr[6] & 0xFF) * 256 ) + (dataArr[7] & 0xFF)))&0xFFFFFFFF */Intpart);
                    mTextView1 = (TextView) findViewById(R.id.textView1);
                    mTextView1.setText(hexdata);
                    mTextView2 = (TextView) findViewById(R.id.textView2);
                    mTextView2.setText(btdata);
                ...
                if (uuid.equals(MY_GATT_CHARACTERISTIC6)) {
                    ...
                    if (!isTechnical){
                        ...
                        hexintdata = String.format("Technical № %02X%02X%02X%02X", dataArr[4] & 0xFF, dataArr[5] & 0xFF, dataArr[6] & 0xFF, dataArr[7] & 0xFF);
                        mTextView1 = (TextView) findViewById(R.id.textNumPosition);
                        mTextView1.setText(hexintdata);
                        //start queries
        ...
        if (!isWriteNow) {
            ...
            mTimer2 = new Runnable() {
                ...
                public void run() {
                    ...
                    mHandler.postDelayed(this, grapfTimeout);
                }
            };
            ...
            mHandler.postDelayed(mTimer1, 5500);
            ...
            mHandler.postDelayed(mTimer3, 3500);
